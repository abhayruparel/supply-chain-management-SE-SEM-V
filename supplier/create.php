                ...
                <div class="card-body">
                    <form action="add.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="pprice">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="pquantity">
</div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Product Color</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="pcolor">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Product Size</div>
                            <div class="value">
                                <div class="input-group">
